...
class Deck:
    ...
    def shuffle(self):
        if len(self.cards) > 1:
            random.shuffle(self.cards)    #to shuffle the cards

    def deal(self,number):  
        cards_delt = []
        for x in range(number): #pop the desired numbers cards from the cards list
            if len(self.cards)>0: #check if the cards are empty
                card = self.cards.pop()
...
class Game:
    def play(self):
        ...
        while game_number < games_to_play:
            ...
            print("Dealers Hand value",dealer_hand_value)
    ...
    def check_winner(self,player_hand,dealer_hand, game_over = False):
        if not game_over:
            ...
            if player_hand.get_value() > 21:
                ...
                print("delear have blackjack, Dealer win!")
                return True     
